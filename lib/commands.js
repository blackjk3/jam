...
commands = {
  ...
  newView: function() {
    ...
    if ( !fs.existsSync("js/app/views/") ) {
      fs.mkdirSync( "js/app/views/", 0755 );
    }

    if ( !fs.existsSync("js/app/templates/") ) {
      fs.mkdirSync( "js/app/templates/", 0755 );
    }

    if ( !fs.existsSync("js/app/helpers/") ) {
  ...
  newModel: function() {
    ...
    if ( !fs.existsSync("js/app/models/") ) {
    ...
    copyFile( this.jaws_root + "/templates/models/backbone-model.js", "js/app/models/" + model + ".js" );
  },
  ...
  newRouter: function() {
    ...
    if ( !fs.existsSync("js/app/routers/") ) {
